...
Käy asettajassa PyCharmiin Django-asetukset. Ne löydät asetukset-valikosta polusta _Languages & Frameworkds > Django_. Valitse ruutu _✅ Enable Django Support_. Tämän jälkeen aseta seuraavat:
...
- _Do not use Django test runner_: Jätä valitsematta!
