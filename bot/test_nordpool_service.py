...
from bot import main, nordpool_service

from bot.nordpool_service import NordpoolCache, round_to_eight, \
...
from bot.utils_format import manipulate_matrix, ManipulationOperation
