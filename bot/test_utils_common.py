...
from bot import main, utils_common
from bot.tests_mocks_v2 import init_chat_user
from bot.utils_common import get_caller_from_stack, object_search, reply_long_text_with_markdown, \
...
@mock.patch('bot.message_handler.handle_update', message_handler_echo_mock)
@pytest.mark.asyncio
