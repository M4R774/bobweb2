...
from bot.nordpool_service import NordpoolCache
from bot.test_nordpool_service import mock_response_200_with_test_data, expected_data_point_count
from bot.tests_mocks_v2 import init_chat_user, MockUser, MockChat, assert_buttons_equals
from bot.tests_utils import assert_command_triggers, async_raise_client_response_error, mock_async_get_json
...
class SahkoCommandFetchOrProcessError(django.test.TransactionTestCase):
    ...
    @mock.patch('bot.async_http.get_content_text', async_raise_client_response_error(status=400))
