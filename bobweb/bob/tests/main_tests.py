...
from bobweb.bob.tests.mocks_v1 import MockUpdate, MockBot, MockUser, MockChat, MockMessage
...
from bobweb.bob.tests.mocks_v2 import init_chat_user
...
class Test(IsolatedAsyncioTestCase):
    ...
    def test_ChatCommand_get_parameters(self):
        command = ChatCommand(name='tests', regex=r'^[/.!]test_command($|\s)', help_text_short=('tests', 'tests'))
