...
from bobweb.bob.tests.daily_question.dq_test_utils import go_to_seasons_menu_v2, \
    populate_season_with_dq_and_answer_v2, populate_season_v2, kysymys_command, go_to_stats_menu_v2
from bobweb.bob.tests.mocks_v2 import MockChat, init_chat_user, MockUser
from bobweb.bob.tests.utils import assert_has_reply_to, assert_no_reply_to
from bobweb.bob.tests.msg_btn_utils import button_labels_from_reply_markup
...
class DailyQuestionTestSuiteV2(TestCase):
    ...
    def test_when_given_start_season_command_with_missing_info_gives_error(self):
        ...
        # tests invalid season name inputs
    ...
    def test_cancel_season_start_and_cancel_season_end_buttons(self):
        # First tests that user can cancel starting a season
        chat, user = init_chat_user()
        go_to_seasons_menu_v2(user)
        ...
        # Then tests that user can cancel ending a season
        populate_season_with_dq_and_answer_v2(chat)
