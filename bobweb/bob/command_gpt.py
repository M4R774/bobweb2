...
class GptCommand(ChatCommand):
    ...
    async def handle_update(self, update: Update, context: CallbackContext = None):
        ...
        # If contains quick system prompt sub command
            ...
            await self.handle_quick_system_prompt_sub_command(update, command_parameter, context)

        else:
            await self.gpt_command(update, command_parameter, context)
    ...
    async def gpt_command(self, update: Update, new_prompt: str, context: CallbackContext = None,
